...
export default function ProjectCard({ project }: ProjectCardProps) {
  return (
    ...
    >
      <div className="aspect-[4/3] rounded-[32px] overflow-hidden bg-gray-100 dark:bg-slate-800 mb-6 transition-transform duration-500 group-hover:scale-[0.98]">
        <img
          src={project.imageUrl}
          alt={project.title}
          className="w-full h-full object-cover transition-all duration-700 group-hover:scale-110"
        />
        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-4 rounded-[32px]">
